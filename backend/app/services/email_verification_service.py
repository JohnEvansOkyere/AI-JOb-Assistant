...
class EmailVerificationService:
    ...
    async def send_verification_code(user_id: UUID, email: str, full_name: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info("Verification code generated", user_id=str(user_id), expires_at=expires_at.isoformat())
        ...
        try:
            ...
            <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                ...
                <div style="background-color: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
                    ...
                    <p style="font-size: 16px;">Thank you for signing up for Veloxa Recruit! To complete your registration, please verify your email address using the code below:</p>
                    
                    <div style="background-color: #f9fafb; padding: 30px; border-radius: 8px; margin: 25px 0; text-align: center; border: 2px dashed #2563eb;">
                    ...
                    <p style="font-size: 16px;">If you didn't create an account with Veloxa Recruit, please ignore this email.</p>
                    
                    <div style="margin: 30px 0; padding: 20px; background-color: #fef3c7; border-radius: 8px; border-left: 4px solid #f59e0b;">
                        <p style="margin: 0; font-size: 14px; color: #92400e;">
                            <strong>🔒 Security Tip:</strong> Never share this code with anyone. Veloxa Recruit will never ask for your verification code.
                        </p>
                    </div>
...
Thank you for signing up for Veloxa Recruit! To complete your registration, please verify your email address using the code below:
...
Security Tip: Never share this code with anyone. Veloxa Recruit will never ask for your verification code.
