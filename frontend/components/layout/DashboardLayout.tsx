 ...
 * Modern sidebar navigation layout for dashboard pages
 */
...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  // Combine navigation with admin items if user is admin
